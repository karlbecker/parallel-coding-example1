        ...
        describe("for a vehicle with an odometer in miles > ") {
            describe("with two entries that are full tanks > ", closure: {
                it("should calculate 5 mpg when the entries are 100 miles apart and the fuel is 20 gallons", closure: {
                    let entry1 = FuelEntry(fuelType: "normal", isFullTank: true, resetFuelEconomy: false, quantity: 1.0, odometer: 100.1, odometerUnits: .miles, date: Date(), notes: "", location: nil, cost: 2.599, currency: "$", quantityUnits: .Gallons)
                    let entry2 = FuelEntry(fuelType: "normal", isFullTank: true, resetFuelEconomy: false, quantity: 20.0, odometer: 200.1, odometerUnits: .miles, date: Date(), notes: "", location: nil, cost: 2.599, currency: "$", quantityUnits: .Gallons)
